...
from seg_lib.models.sam_med2d.modeling import (
    ImageEncoderViT, MaskDecoder, PromptEncoder, Sam, TwoWayTransformer
)

def build_sam_med_2d_vit_h(args):
    return _build_sam(
...
build_sam_med_2d = build_sam_med_2d_vit_h


def build_sam_med_2d_vit_l(args):
    return _build_sam(
...
def build_sam_med_2d_vit_b(args):
    return _build_sam(
...
sam_med_2d_model_registry = {
    "default": build_sam_med_2d_vit_h,
    "vit_h": build_sam_med_2d_vit_h,
    "vit_l": build_sam_med_2d_vit_l,
    "vit_b": build_sam_med_2d_vit_b,
}
