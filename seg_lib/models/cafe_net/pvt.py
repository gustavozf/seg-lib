...
from seg_lib.models.cafe_net.pvtv2 import pvt_v2_b2
from seg_lib.models.cafe_net.PSA import PSA_p
...
class CAFE(nn.Module):
    def __init__(self, pvtv2_path: str='./pretrained_pth/pvt_v2_b2.pth'):
        super(CAFE, self).__init__()

        self.backbone = pvt_v2_b2()  
        save_model = torch.load(pvtv2_path)
